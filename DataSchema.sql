...
CREATE TABLE ProtectiveEquipment (
...
CREATE TABLE RiskRemovalInstruction (
    instruction_id SERIAL PRIMARY KEY,
    notification_id INTEGER REFERENCES Notification(notification_id),
    equipment_id INTEGER REFERENCES ProtectiveEquipment(equipment_id),
